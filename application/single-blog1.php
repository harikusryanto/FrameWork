                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-center">
                            <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(); ?>assets1/index.html">Beranda</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>assets1/blog.html">Perkembangan Anak</a></li>
                            <!--<li class="nav-item"><a class="nav-link" href="gallery.html">Galeri</a>-->
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                                 aria-expanded="false">Ibu & Anak</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>assets1/blog.html">Artikel</a>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>assets1/blog.html">Video Edukasi</a>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>assets1/single-blog.html">Tips-Tips</a>
                                </ul>
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url(); ?>assets1/about-us.html">Tentang Kami</a></li>
                            </li>
                            <!--<li class="nav-item submenu dropdown">
                            <!--<li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<div class="page_link">
							<a href="<?php echo base_url(); ?>assets1/index.html">Home</a>
							<a href="<?php echo base_url(); ?>assets1/single-blog.html">Blog Details</a>
						</div>
						<h2>BLOG DETAILS</h2>
					</div>
				</div>
                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="<?php echo base_url(); ?>assets1/img/info1.jpg" width="800" alt="">
                                </div>									
                            </div>
                            ...
                            <div class="col-lg-9 col-md-9 blog_details">
                                <h2>Informasi Perkembangan Anak</h2>
                                <p class="excert">
                            ...
                            <div class="col-lg-12">
                                <div class="quotes">
                                    "Mengoptimalkan Tumbuh Kembang Anak sesuai tahapan usia adalah hal penting bagi para orang tua"										
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <img class="img-fluid" src="<?php echo base_url(); ?>assets1/img/blog/post-img1.jpg" alt="">
                                    </div>
                                    <div class="col-6">
                                        <img class="img-fluid" src="<?php echo base_url(); ?>assets1/img/blog/post-img2.jpg" alt="">
                                    </div>	
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    <div class="thumb">
                                        <a href="#"><img class="img-fluid" src="<?php echo base_url(); ?>assets1/img/blog/prev.jpg" alt=""></a>
                                    </div>
                                    <div class="arrow">
