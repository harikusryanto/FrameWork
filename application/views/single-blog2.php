                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-center">
                            ...
                            <li class="nav-item"><a class="nav-link" href="blog.html">Perkembangan Anak</a></li>
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="blog.html">Video Edukasi</a>
                                    <li class="nav-item"><a class="nav-link" href="single-blog.html">Tips-Tips</a>
                                </ul>
                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="img/info2.jpg" width="800" alt="">
                                </div>									
                            </div>
                            ...
                            <div class="col-lg-9 col-md-9 blog_details">
                                <h2>Gejala Perkembangan Anak 0-12 tahun</h2>
                                <p class="excert">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <img class="img-fluid" src="img/blog/post-img3.jpg" alt="">
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-lg-12 mt-25">
                                        <p>
                                            Meski setiap anak memiliki perkembangan yang berbeda, umumnya bayi yang baru lahir hingga usia 3 bulan akan lebih sering senyum-senyum sendiri. Jadi, jangan heran ketika Anda melihat bayi yang baru lahir senyum-senyum sendiri meski Anda tidak mengajaknya bercanda.Sama halnya dengan orang dewasa, bayi tersenyum karena mereka merespon sesuatu atau sedang merasa senang. Hal ini adalah reflek alami yang dimiliki setiap bayi sejak mereka di dalam rahim.
                                        </p>
                                        <p>
                                            Menginjak usia dua hingga tiga bulan, senyuman yang dimunculkan bayi tidak lagi spontan yang berasal dari rangsangan otaknya. Bayi akan mulai tersenyum akibat merespon berbagai hal yang ia lihat. Selain itu, bayi juga akan menanggapi rangsangan suara yang muncul, seperti suara ibu, ayah, atau mainannya. Tanggapan yang diberikan bayi ini adalah dengan senyuman.
                                        </p>											
                                    </div>									
                                </div>
                            </div>
